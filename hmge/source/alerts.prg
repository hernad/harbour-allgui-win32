...
*-----------------------------------------------------------------------------*
   // replace the text with your own language
...
*-----------------------------------------------------------------------------*
FUNCTION AlertExclamation ( Message, Title, Icon, nSize, aColors, lTopMost, bInit )
*-----------------------------------------------------------------------------*
   LOCAL nWaitSec
...
*-----------------------------------------------------------------------------*
FUNCTION AlertInfo ( Message, Title, Icon, nSize, aColors, lTopMost, bInit )
*-----------------------------------------------------------------------------*
   LOCAL nWaitSec
...
*-----------------------------------------------------------------------------*
FUNCTION AlertStop ( Message, Title, Icon, nSize, aColors, lTopMost, bInit )
*-----------------------------------------------------------------------------*
   LOCAL nWaitSec
...
*-----------------------------------------------------------------------------*
   DEFAULT cMsg := "", nDefault := 0, lTopMost := .F.

   IF ! Empty( nDefault )
      _HMG_ModalDialogReturn := nDefault
   ENDIF

   IF lTopMost .AND. Empty( bInit )
