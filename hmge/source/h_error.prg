...
*-----------------------------------------------------------------------------*
#ifndef __XHARBOUR__
   LOCAL cVer := "Harbour MiniGUI Extended Edition 19.08 (" + hb_ntos( hb_Version( HB_VERSION_BITWIDTH ) ) + "-bit)"
#else
   LOCAL cVer := "Harbour MiniGUI Extended Edition 19.08 (" + iif( IsExe64(), "64", "32" ) + "-bit)"
#endif
   LOCAL anOfs := { Len( cVer ), 39, 15 }
