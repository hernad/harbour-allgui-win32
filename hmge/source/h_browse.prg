...
FUNCTION _DefineBrowse ( ControlName, ParentFormName, x, y, w, h, aHeaders, aWidths, aFields, value, ;
      ...
      inputitems , displayitems , doublebuffer , columnsort , bInit )
*-----------------------------------------------------------------------------*
   ...
   _HMG_aControlMiscData1 [k] := { ;
      0 , appendable , readonly , ;
      valid , validmessages , ;
      edit , nogrid , novscroll , ;
      dynamicforecolor , dynamicbackcolor , ;
      aWhenFields , Delete , ;
      inputitems , displayitems , ;
      0 , aJust , NIL , NIL , doublebuffer , ;
      iif( lsort, Array( Len( aHeaders ) ), 0 ) ;
      }
