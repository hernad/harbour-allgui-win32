...
IF !FILE (GetCurrentFolder()+"\TIPOS.CDX")
   ...
   If !NetErr()
      ...
      DBCLOSEAREA()
   Else
      MsgStop('El archivo de datos "TIPOS" está bloqueado '," por favor, inténtelo de nuevo ")
      Return
   EndIF
Endif
...
IF !FILE (GetCurrentFolder()+"\CONTACTOS.CDX")
   ...
   If !NetErr()
      ...
      DBCLOSEAREA()
   Else
      MsgStop('El archivo de datos "CONTACTOS" está bloqueado '," por favor, inténtelo de nuevo ")
      Return
   EndIF
Endif
